...
class Settings(BaseSettings):
    ...
    # Database Settings
    SQLITE_DB_PATH: str = "/app/data/db/main.db"
...
def create_directories():
    ...
    directories = [
        ...
        settings.CACHE_DIR,
        Path(settings.SQLITE_DB_PATH).parent  # Create the parent directory for the database file
    ]
    
    for directory in directories:
        # Only create if it's not already a file
